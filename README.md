...
This project analyzes an Indian food delivery platform (Zomato) using SQL, covering the entire analytics workflow from database schema design and data validation to advanced business insights using window functions and time-based analysis.
The objective is to demonstrate production-ready SQL skills applied to realistic business problems commonly faced by food-tech companies such as Wolt, Swiggy, Uber Eats, or DoorDash.
## Business Questions Addressed
This analysis answers 20+ real-world business questions, including:
- Top dishes ordered by high-value customers
- Peak ordering time slots (2-hour intervals)
- Customer Average Order Value (AOV) & Lifetime Value (CLV)
- High-spending customer identification
- Undelivered and cancelled orders analysis
- Restaurant revenue ranking (city-wise)
- Customer churn detection (year-over-year)
- Monthly growth rates for restaurants
- Rider efficiency, earnings & performance ratings
- Seasonal demand trends
- City-wise revenue rankings

## Database Schema Design
The project uses a normalized relational schema consisting of five core tables:
- customers – customer profile & registration data
- restaurants – restaurant metadata and city mapping
- orders – transactional order-level data
- deliveries – delivery execution and status
- riders – delivery personnel information

Foreign keys ensure referential integrity between orders, customers, restaurants, and riders.
```sql
...
Order by 3 desc;
```
**Q6. Rank restaurants by their total revenue from the last year. Return: restaurant_name, total_revenue, and their rank within their city.**
```sql
Select*
from
(Select 
...
## Key Highlights
**Advanced Ranking**
- Top dishes per customer
- Best-performing restaurants per city
- City-wise revenue rankings
  
**Customer Analytics**
- AOV & CLV calculation
- High-value and churned customers
- Spending-based segmentation
  
**Operations & Logistics**
- Rider efficiency analysis
- Delivery time-based rider ratings
- Monthly rider earnings (commission-based)
  
**Business Growth Metrics**
- Monthly restaurant growth rates
- Seasonal demand analysis
- Order cancellation trends (YoY comparison)
